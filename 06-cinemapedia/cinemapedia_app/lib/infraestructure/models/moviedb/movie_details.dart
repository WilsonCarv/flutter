...
MovieDetailsDb movieDetailsDbFromJson(String str) => MovieDetailsDb.fromJson(json.decode(str));

String movieDetailsDbToJson(MovieDetailsDb data) => json.encode(data.toJson());
...
class MovieDetailsDb {
    ...
    factory MovieDetailsDb.fromJson(Map<String, dynamic> json) => MovieDetailsDb(
        adult: json["adult"],
